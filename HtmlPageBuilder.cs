...
namespace Lab11_5EFCoreDbContextLINQSakilaDB
{
    class HtmlPageBuilder
    {
        ...
        public void CollectThenCreateHTML(Film[] arDataSource)
        {
            ...
            int liCount = 0;
            if (arDataSource.Length > 0)
            {

                liCount = arDataSource.Length;
            ...
            for (int li = 0; li < liCount; li++)
            {
                ...
                htmlText.Append(htmlLIOpen);
                dynamicHtml = $"{arDataSource[li].title} {arDataSource[li].release_year} {arDataSource[li].description} ";
                htmlText.Append(dynamicHtml);
                htmlText.Append(htmlLIClose);
        ...
        public void WriteFile()
        {
            ...
            FileWriter fw = new FileWriter(@"C:\CSharpLabs\Lab11_5.html", htmlText.ToString());
            fw.WriteThisFile();
        }
